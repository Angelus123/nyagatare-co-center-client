...
const services = [
  { label: "Café & Restaurant", icon: Coffee, href: "/cafe-restaurant" },
  { label: "Guest House", icon: Home, href: "/guest-house" },
  { label: "Art Gallery", icon: Palette, href: "/art-gallery" },
  { label: "Craft Shop", icon: ShoppingBag, href: "/craft-shop" },
];
            ...
            {services.map((service) => {
              ...
              return (
                <li key={service.label}>
                  <Link
                    href={service.href}
                    className="flex items-center gap-2 px-6 py-2.5 rounded-full border border-red-400/70 text-sm sm:text-base hover:bg-red-400/10 transition-colors whitespace-nowrap"
                  >
