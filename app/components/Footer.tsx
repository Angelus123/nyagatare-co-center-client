...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-b from-amber-900 to-amber-950 text-amber-100 py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand Section */}
          <div className="space-y-4">
            <h3 className={`${playfair.className} text-3xl font-bold text-white`}>Insight Art Space</h3>
            <p className="text-amber-200 text-sm leading-relaxed">
              Preserving traditional craftsmanship through modern appreciation.
            </p>
            ...
            <ul className="space-y-3 text-sm">
              {['All Products', 'New Arrivals', 'Best Sellers', 'Sale'].map((item) => (
                <li key={item}>
                  <a
                    href="#"
                    className="text-amber-200 hover:text-white transition-colors duration-200 hover:underline"
                  >
                    {item}
                  </a>
                </li>
          ...
          <div>
            ...
            <address className="not-italic text-sm text-amber-200 space-y-2">
              <p>123 Craft Avenue</p>
              <p>Artisan Village, AV 12345</p>
              <p>
                <a href="mailto:hello@artisancrafts.com" className="hover:text-white transition-colors">
